  ...
  useEffect(() => {
    const getOrders = async () => {
      try {
        ...
        const cookingOrders = await fs.get("cooking");
    ...
    <>
      ...
      >
        <div className="d-flex align-items-center">
          ...
          <div className="custom-header ">Cooking </div>
        </div>
      </div>
      <br />
      <div
      ...
      <div style={{ margin: "10px 70px 10px -20px" }}>
        {orders &&
          orders.map((o) => {
            return <OrderSection order={o} status="parcelready" />;
          })}
      </div>
    </>
  );
